# This file was cloned from the code associated to the papers "The relative class number problem for function fields, I" and
...
# If t = 0, the covers must be everywhere unramified.
# If t > 0, the covers have t geometric ramification points on the base;
# this assumes t <= 2.
def cyclic_covers(F, d, t=0, q=2):
    ans = []
...
def match_weil_poly(F, t=0, verbose=False, q=2):
    ans = []
    for F1 in cyclic_covers(F, d, t=t, q=q):
        if verbose:
